...
#read csv
def Macro(gameMode,csv_file,writefile_csv_lifetime,writefile_csv_matches,gameMode_matches,match_type):
...
Macro("squad","squad_new.csv","lifetime_squad_new.csv","matches_squad_new.csv","matchesSquad","Squad")
Macro("squad-fpp","squad_fpp_new.csv","lifetime_squad_fpp_new.csv","matches_squad_fpp_new.csv","matchesSquadFPP","SquadFPP")
